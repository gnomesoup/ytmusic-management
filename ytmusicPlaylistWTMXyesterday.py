...
def UpdateWTMXYesterday(
    ytmusic:YTMusic, playlistId:str, dbConnectionString:str=None
) -> bool:
    """Collect playlist data on WTMX from yesterday and import it to a YouTube
    Music playlist. 
    ...
    headers = {
        ...
        "Content-Length": "32",
        "Origin": "https://live.wtmx.com",
        "DNT": "1",
        "Connection": "keep-alive",
        "Referer": "https://live.wtmx.com/listen/",
